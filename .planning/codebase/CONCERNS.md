...
- **Issue:** CLI implementation is entirely in `claw-cli.ts` (967 lines) with no modular separation
- **Files:** `claw-cli.ts`
- **Impact:**
  ...
  - Code duplication between `claw-cli.ts` and `src/index.ts` (secret detection, URL validation, auth headers)
...
- **Issue:** Secret leak detection, URL validation, redaction, and auth header logic are duplicated across `claw-cli.ts` and `src/index.ts`
- **Files:** `claw-cli.ts` (lines 45-114), `src/index.ts` (lines 7-132)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 287-296)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 496-502)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 300-302)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 244-245, 284-285)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 140-150, 308-310)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 629-651)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 548-599, 518-546)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 340, 369), `src/index.ts` (lines 229, 263)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 636, 656)
- **Impact:**
...
- **Files:** `claw-cli.ts` (lines 961-967), `src/index.ts` (lines 237-244)
...
- **Files:** `claw-cli.ts` (lines 393-403, 669-701)
...
- **Files:** `claw-cli.ts` (lines 225-232)
...
- **Files:** `claw-cli.ts` (lines 118-134), `src/index.ts` (lines 76-107)
...
- **Files:** `claw-cli.ts` (lines 313-320), `src/index.ts` (lines 281-291)
...
- **Files:** `claw-cli.ts` (lines 50-58), `src/index.ts` (lines 13-26)
...
- **Files:** `claw-cli.ts` (lines 496-507)
...
- **Files:** `claw-cli.ts` (lines 638-639, 658-659)
...
- **Files:** `claw-cli.ts` (lines 333, 364)
...
- **Files:** `claw-cli.ts` (lines 481-546)
- **Why fragile:**
...
- **Files:** `claw-cli.ts` (lines 628-651)
- **Why fragile:**
...
- **Files:** `claw-cli.ts` (lines 554-579)
- **Why fragile:**
...
- **Files:** `claw-cli.ts` (lines 38, 219, 256, 426, etc.), `src/index.ts` (entire SDK)
- **Impact:**
...
- **What's not tested:**
  ...
  - Exact key matching
- **Files:** `claw-cli.ts` (lines 45-91), `src/index.ts` (lines 7-74)
...
- **Files:** `claw-cli.ts` (lines 323-385), `src/index.ts` (lines 211-278)
...
- **Files:** `claw-cli.ts` (all command functions)
