...
| **Full suite command** | `npm run build && AGENT_PRIVATE_KEY=0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef CLAW_KEY_PASSWORD=test123 node dist/claw-cli.js init --non-interactive 2>&1` |
...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 2-01-01 | 01 | 1 | MAGT-01 | cli | `grep -q "keystores" dist/claw-cli.js` | ❌ W0 | ⬜ pending |
| 2-01-02 | 01 | 1 | KEYS-01 | cli | `npm run build && AGENT_PRIVATE_KEY=0x... CLAW_KEY_PASSWORD=test node dist/claw-cli.js init --non-interactive` | ❌ W0 | ⬜ pending |
| 2-01-03 | 01 | 1 | KEYS-02 | cli | `grep -q "CLAW_KEY_PASSWORD" dist/claw-cli.js` | ❌ W0 | ⬜ pending |
| 2-01-04 | 01 | 1 | MAGT-02 | cli | `grep -q "agent" dist/claw-cli.js && grep -q "CLAW_AGENT_ADDRESS" dist/claw-cli.js` | ❌ W0 | ⬜ pending |
| 2-01-05 | 01 | 1 | MAGT-03 | cli | `grep -q "auto-select" dist/claw-cli.js || grep -q "single keystore" dist/claw-cli.js` | ❌ W0 | ⬜ pending |
